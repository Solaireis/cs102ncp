...
public class Q6PartC {
    ...
    public static String getFarmerDetails(CommunityGarden garden, int plotNumber) {
        ...
        String farmer = garden.getPlot(plotNumber).getFarmer().getName();
        char gender = garden.getPlot(plotNumber).getFarmer().getGender();
        String fullGender;
        ...
        return farmer + fullGender; // added to make this code compile.
